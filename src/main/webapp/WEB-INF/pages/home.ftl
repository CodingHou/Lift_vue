		...
		<div id="content">
			...
			<div id="list-box">
				<div class="list" id="addList">
					...
					<span class="rateVal" id="numb"></span>
				</div>
				...
				<div class="list" id="addList">
					...
					<div class="title">
						<input type="text" class="listInput" placeholder="标题">
						<span class="listSpan">试一试</span>
					</div>
					<!--日期-->
					<div class="day">
						<input type="date" class="listInput">
						<span class="listSpan">2017-10-10</span>
					</div>
					<!--进度条-->
					<div class="rate">
						<div class="ratio">
					...
					<span class="rateVal" id="numb">5/2</span>
				</div>
